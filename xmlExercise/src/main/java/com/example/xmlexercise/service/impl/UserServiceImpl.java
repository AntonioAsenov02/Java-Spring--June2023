...
import com.example.xmlexercise.model.dto.UserWithAtLeastOneSoldProductDto;
...
public class UserServiceImpl implements UserService {
    ...
    public UserViewRootDto findUsersWithAtLeastOneProductSold() {
        ...
        rootDto.setUsers(userRepository.findAllWithAtLeastOneProductSoldOrderedByLastNameAndFirstName()
                .stream()
