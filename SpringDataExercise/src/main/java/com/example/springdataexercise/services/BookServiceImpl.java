...
import com.example.springdataexercise.models.entities.*;
...
public class BookServiceImpl implements BookService {
    ...
    private Book createBookFromInfo(String[] bookInfo) {
        ...
        Integer countOfCopies = Integer.parseInt(bookInfo[2]);
        ...
        return new Book(editionType, releaseDate,countOfCopies,price, ageRestriction, title, author, categories);
    }
}
